...
module.exports = function(app, passport, db) {
	...
	app.get('/home', function(request, response) {
		...
		// response.render('pages/home.html', { 'user': request.user, 'categories' : [
		// 		{ name: 'Financial Aid', image: 'matthew.png', url: 'category?type=finaid'}, 
		// 		{ name: 'Housing', image: 'matthew.png', url: 'category?type=housing'},
		// 		{ name: 'Frats / Sororities', image: 'matthew.png', url: 'category?type=frats'},
		// 		{ name: 'Dining Plans', image: 'matthew.png', url: 'category?type=dining'},
		// 		{ name: 'Summer Storage', image: 'matthew.png', url: 'category?type=summerstorage'},
	  ...
	  siteVisit.save(function(error, visit) {
		...
		Link.find( { 'category' : request.query.type }, function(error, links) {
			if(error) {
				...
				tags = [];
				response.render('pages/links.html', { 'user': request.user, 'category': request.query.name, 'categoryid': request.query.type, 'tags': tags, 'links': links });
			}
		});
		// response.render('pages/links.html', { 'user': request.user, 'tags' : [
		// 		{ name: 'Financial Aid', image: 'matthew.png', url: 'category?type=finaid'}, 
		// 		{ name: 'Housing', image: 'matthew.png', url: 'category?type=housing'},
		// 		{ name: 'Frats / Sororities', image: 'matthew.png', url: 'category?type=frats'},
		// 		{ name: 'Dining Plans', image: 'matthew.png', url: 'category?type=dining'},
	...
	// 		// fs.readFile(request.photos.displayImage.path, function (err, data) {
	// 		//   // ...
